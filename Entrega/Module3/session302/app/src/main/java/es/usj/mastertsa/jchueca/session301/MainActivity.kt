...
import es.usj.mastertsa.jchueca.session301.model.Tile
...
class MainActivity : AppCompatActivity() {
    ...
    inner class Board(context: Context) : View(context)
    {
        ...
        private fun prepareTile(activity: MainActivity, row: Int, column: Int, tileSize: Int, currentRow: Int, canvas: Canvas ): Tile
        {
